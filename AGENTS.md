...
- **Build before commit** — when changing code, run `dotnet build` (and relevant `dotnet test` filters for touched areas) locally before committing to catch CI-breaking issues early.
