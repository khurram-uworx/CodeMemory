...
- `src/CodeMemory.Storage/LiteGraph/InMemoryGraphRepository.cs` (new)
- `src/CodeMemory.Storage/LiteGraph/InMemoryGraphMethods.cs` (new)
- `src/CodeMemory.Storage/LiteGraph/InMemoryNodeMethods.cs` (new)
...
- `src/CodeMemory.Storage/LiteGraph//InMemoryTenantMethods.cs` (new)
- `src/CodeMemory.Storage/LiteGraph//InMemoryGraphMethods.cs` (new)
- `src/CodeMemory.Storage/LiteGraph//InMemoryNodeMethods.cs` (new)
- `src/CodeMemory.Storage/LiteGraph//InMemoryEdgeMethods.cs` (new)
- `src/CodeMemory.Storage/LiteGraph//InMemoryUserMethods.cs` (new)
- `src/CodeMemory.Storage/LiteGraph//InMemoryCredentialMethods.cs` (new)
...
- `src/CodeMemory.Storage/LiteGraph//InMemoryLabelMethods.cs` (new)
- `src/CodeMemory.Storage/LiteGraph//InMemoryTagMethods.cs` (new)
- `src/CodeMemory.Storage/LiteGraph//InMemoryVectorMethods.cs` (new)
...
- `src/CodeMemory.Storage/LiteGraph//InMemoryVectorMethods.cs`
- `src/CodeMemory.Storage/LiteGraph//InMemoryVectorIndex.cs` (new, if needed)
- `src/CodeMemory.Tests/Benchmarks/InMemoryVectorBenchmark.cs` (new, if needed)
...
- `src/CodeMemory.Tests/LiteGraph/InMemoryGraphRepositoryTests.cs` (new)
- `GraphRepositoryFactory.cs` (add `InMemory` case)
...
- `src/CodeMemory.Tests/Benchmarks/InMemoryVsSqliteBenchmarks.cs` (new)
