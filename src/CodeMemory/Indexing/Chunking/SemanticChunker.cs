...
public sealed class SemanticChunker
{
    ...
    private static string ExtractFileContext(string[] fileLines)
    {
    ...
    private static DocumentChunk CreateTypeChunk(
        Symbol symbol,
        string[] fileLines,
        string fileContext,
        string filePath,
    ...
    private static DocumentChunk CreateMemberChunk(
        Symbol symbol,
        string[] fileLines,
        string filePath,
        Language language)
    ...
    private static string ExtractLines(string[] fileLines, LineRange range)
    {
    ...
    private static string? ExtractParentName(string fullName)
    {
    ...
    private static string ComputeId(string symbolId, string content, string filePath)
    {
